/**
 * @file 16_sum-k1-smallest-k2-largest.cpp
 * @author Anikthe_27 (aniket.kumar.giri2707@gmail.com)
 * @brief Sum of Elements between k1 smallest and k2 largest numbers
 * @date 2022-08-10
 *
...
class Solution {
   ...
   public:
    long long sumBetweenTwoKth(long long arr[], long long N, long long K1,
                               long long K2) {
        // Your code goes here
        long long num1 = kthSmallest(arr, N, K1);
        long long num2 = kthLargest(arr, N, K2);
        int ans = 0;
        for (int i = 0; i < N; i++) {
